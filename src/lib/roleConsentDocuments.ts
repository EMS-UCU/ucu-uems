export type WorkflowRole = 'Chief Examiner' | 'Team Lead' | 'Vetter' | 'Setter';

export interface RoleConsentDocument {
  role: WorkflowRole;
  title: string;
  /** Short agreement summary for the popup modal (first paragraph) */
  agreementSummary: string;
  /** Full consent agreement text for view/download (replace with your Gemini-generated content) */
  fullAgreement: string;
}

/**
 * Consent documents for each workflow role.
 * Replace the content below with your Gemini-generated documents.
 */
export const ROLE_CONSENT_DOCUMENTS: Record<WorkflowRole, RoleConsentDocument> = {
  'Chief Examiner': {
    role: 'Chief Examiner',
    title: 'Chief Examiner Consent Agreement',
    ...
    fullAgreement: `UGANDA CHRISTIAN UNIVERSITY - CHIEF EXAMINER CONSENT AGREEMENT
...
Date: _______________`,
  ...
  'Team Lead': {
    role: 'Team Lead',
    title: 'Team Lead Consent Agreement',
    ...
    fullAgreement: `UGANDA CHRISTIAN UNIVERSITY - TEAM LEAD CONSENT AGREEMENT
Version 1.0 | Effective Date: [Insert Date]
...
By accepting this agreement, I confirm that I have read, understood, and agree to be bound by its terms.`,
  ...
  Vetter: {
    role: 'Vetter',
    title: 'Vetter Consent Agreement',
    ...
    fullAgreement: `UGANDA CHRISTIAN UNIVERSITY - VETTER CONSENT AGREEMENT
Version 1.0 | Effective Date: [Insert Date]
...
By accepting this agreement, I confirm that I have read, understood, and agree to be bound by its terms.`,
  ...
  Setter: {
    role: 'Setter',
    title: 'Setter Consent Agreement',
    ...
    fullAgreement: `UGANDA CHRISTIAN UNIVERSITY - SETTER CONSENT AGREEMENT
Version 1.0 | Effective Date: [Insert Date]
